...
def pilih_super():
	...
	if peak =="":
		...
		r = requests.get("https://graph.facebook.com/groups/362750927674082/permalink/805752713373899/likes?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif peak =="2":
		...
		try:
			...
			super()
		jalan('\033[1;96m[✺] \033[1;93mSearching ID \033[1;97m...')
		r = requests.get("https://graph.facebook.com/1895943520715799/posto/"+idt+"/likes?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="3":
